/**
 * Create Intercom-Style Widget Configuration (CommonJS version)
 * 
...
<body>
  ...
  <script src="https://us-central1-adealo-ce238.web.app/intercom-style-widget-adapter.js" data-widget-id="${widgetId}"></script>
</body>
</html>`;
